...
require_relative "ct_sdt_content_block"
class CTSdtBlock < Lutaml::Model::Serializable
  ...
  def self.register_class_with_id
    register.register_model(self, id: :ct_sdt_block)
  end
end

CTSdtBlock.register_class_with_id
