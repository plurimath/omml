  ...
  module Models
    class CTAnchor < Lutaml::Model::Serializable
      ...
      xml do
        ...
        sequence do
          map_element :simplePos, to: :simple_pos, render_empty: true
          map_element :positionH, to: :position_h, render_empty: true
          map_element :positionV, to: :position_v, render_empty: true
