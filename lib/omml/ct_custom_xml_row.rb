...
class CTCustomXmlRow < Lutaml::Model::Serializable
  ...
  xml do
    root "CustomXmlRow", ordered: true
  ...
  def self.register_class_with_id
    register.register_model(self, id: :ct_custom_xml_row)
  end
end

CTCustomXmlRow.register_class_with_id
