...
class EGRunInnerContent < Lutaml::Model::Serializable
  ...
  xml do
    ...
    map_element :t, to: :t
    map_element :delText, to: :del_text
    map_element :instrText, to: :instr_text
    map_element :delInstrText, to: :del_instr_text
    map_element :noBreakHyphen, to: :no_break_hyphen
    ...
    map_element :fldChar, to: :fld_char
  ...
  def self.register_class_with_id
    register.register_model(self, id: :eg_run_inner_content)
  end
end

EGRunInnerContent.register_class_with_id
