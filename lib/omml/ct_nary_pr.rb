...
class CTNaryPr < Lutaml::Model::Serializable
  ...
  xml do
    ...
    sequence do
      ...
      map_element :subHide, to: :sub_hide, namespace: "http://schemas.openxmlformats.org/officeDocument/2006/math", prefix: "m"
      map_element :supHide, to: :sup_hide, namespace: "http://schemas.openxmlformats.org/officeDocument/2006/math", prefix: "m"
