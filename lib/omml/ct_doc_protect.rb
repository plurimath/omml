...
require_relative "st_doc_protect"
...
class CTDocProtect < Lutaml::Model::Serializable
  attribute :edit, :st_doc_protect
  attribute :formatting, :st_on_off
  attribute :enforcement, :st_on_off
  ...
  def self.register_class_with_id
    register.register_model(self, id: :ct_doc_protect)
  end
end

CTDocProtect.register_class_with_id
