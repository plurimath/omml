...
class CTTcBorders < Lutaml::Model::Serializable
  ...
  attribute :tl2br, :ct_border, collection: 0..1
  ...
  xml do
    ...
    sequence do
      ...
      map_element :tl2br, to: :tl2br
      map_element :tr2bl, to: :tr2bl
    end
  end
  ...
  def self.register_class_with_id
    register.register_model(self, id: :ct_tc_borders)
  end
end

CTTcBorders.register_class_with_id
